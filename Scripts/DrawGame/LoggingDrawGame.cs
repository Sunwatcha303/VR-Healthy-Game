...
public class LoggingDrawGame : MonoBehaviour
{
    ...
    public void SaveToLog(int shape, int level, double time, double timeOutTheBox, char hand)
    {
        ...
        string[] dataToAppend = { PlayerPrefs.GetString("currentId", "0000"), "" + shape, "" + level , "" + time.ToString("F2"), ""+timeOutTheBox.ToString("F2"), ""+hand, ""+DateTime.Today.ToString("dd/MM/yyyy") };
